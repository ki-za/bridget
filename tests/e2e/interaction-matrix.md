...
| Mobile track        | Resting state                     | No contribution tags                            | With no hover input, mobile does not show the desktop-only small-tag preview                     | Track selection              |
| Mobile track        | Tap anywhere in row               | Track selected                                  | That track alone shows full labels                                                               | Track selection              |
| Selected track      | Click / tap same row              | No selected track                               | Full labels close; desktop returns to its current hover preview and mobile returns to no tags    | Track selection              |
| Selected track      | Click / tap another row           | New track selected                              | The old labels close and only the new track shows full labels                                    | Track selection              |
