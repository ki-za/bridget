...
| Slideshow           | Navigate with pointer stationary  | Slideshow                                       | Current cursor label persists through crossfade; Loading appears only while the image loads      | Cursor continuity            |
...
| Desktop track       | Hover anywhere in row             | Small contribution tags                         | Tag colors appear as slivers without text; selection does not change                             | Track hover                  |
| Desktop track       | Click anywhere in row             | Track selected                                  | That track alone shows full labels, including while the pointer remains over the row             | Track selection              |
| Mobile track        | Resting state                     | No contribution tags                            | With no hover input, mobile initially hides all track tags                                       | Track selection              |
| Mobile track        | First tap anywhere in row         | Small contribution tags                         | That track alone shows color-coded slivers without text                                          | Track selection              |
| Mobile small tags   | Second tap on same row            | Full contribution labels                        | The slivers expand and reveal their text                                                         | Track selection              |
| Mobile full labels  | Third tap on same row             | No contribution tags                            | The labels close completely                                                                      | Track selection              |
| Active track        | Click / tap another row           | New track active                                | The old tags close; desktop opens the new full labels and mobile opens the new small tags        | Track selection              |
